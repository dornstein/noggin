...
| [`2026-07-runtime-auth-and-authenticated-providers.md`](2026-07-runtime-auth-and-authenticated-providers.md) | proposed | Auth broker + credential store + sign-in strategies so providers can talk to services (Graph, GitHub, Notion, Jira, …) without each rolling its own auth |
